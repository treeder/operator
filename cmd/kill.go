...
var killCmd = &cobra.Command{
	Use:   "kill",
	Short: "Kills servers",
	Long: `Kills a server by passing in a an instance ID. 
	
	eg: docker run treeder/operator kill INSTANCE_ID
	
	Get instance ids for an app with treeder/operator instances`,
